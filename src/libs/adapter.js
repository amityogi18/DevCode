...
if (typeof window === 'undefined' || !window.navigator) {
  ...
  getUserMedia = function(constraints, onSuccess, onError) {
	...
	webrtcUtils.log('going to get media method');
    return navigator.webkitGetUserMedia(constraints, onSuccess, onError);
	webrtcUtils.log('came back from taht method');
  };
  navigator.getUserMedia = getUserMedia;
  ...
  if (!navigator.mediaDevices.getUserMedia) {
    ...
    // constraints.
	console.log('calling webrtc getmedia fucntion2');
...
webrtcUtils.log('showing chorme message');
      webrtcUtils.log('chrome: ' + JSON.stringify(c));
webrtcUtils.log('going to get media method 2');
