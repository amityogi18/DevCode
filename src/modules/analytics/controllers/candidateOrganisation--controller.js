let _this;
/*
 @candidateOrganisationController Controller
 ...
 */
export class candidateOrganisationController {
	/** @ngInject  */
  constructor(analyticsService, AuthService) { 
    ...
    _this.$onInit = function(){
        ...
        _this.getCandidateOrgnGraph();
        }
    _this.candidateOrgnData ={};
    _this.colors = ['#458bc4','#d0d6cb','#e2ab3b','#626773','#4fc55b'];

  }
  
  getCandidateOrgnGraph(){
       let query = "";
    ...
    if(angular.isDefined(_this.durationId) 
       ...
       let onSuccess = (response) => {
            console.log(response.data);
             _this.candidateOrgnData = response.data || [];  
        },
        onError = (error) =>{
            console.log(error);
        };
      _this.analyticsService.getCandidateOrgnGraphData(query);
