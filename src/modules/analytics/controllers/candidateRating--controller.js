let _this;
/*
 @candidateRatingController Controller
 ...
 */
export class candidateRatingController {
	/** @ngInject  */
  constructor(analyticsService, AuthService) {  
    ...
    _this.$onInit = function(){
        ...
        _this.getCandidateRatingGraph();
        }
    _this.candidateRatingData ={};
    _this.colors = ['#458bc4','#d0d6cb','#e2ab3b'];
  }
  
  getCandidateRatingGraph(){
       let query = "";
    ...
    if(angular.isDefined(_this.durationId) 
       ...
       let onSuccess = (response) => {
            console.log(response.data);
             _this.candidateRatingData = response.data || [];  
        },
        onError = (error) =>{
            console.log(error);
        };
      _this.analyticsService.getCandidateRatingGraphData(query);
